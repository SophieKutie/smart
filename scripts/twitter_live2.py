...
# terms_file = os.listdir('../test/data/abusive_terms/')
...
#
#
# def run_script(start_date1, end_date1,
#                output_file='./test/data/{datetime.now().strftime("%Y%m%d-%H%M%S")}_tweets.json', reps=1000):
